defmodule Comiditas.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Comiditas.Repo)
  ...
  """
  def valid_password?(%Comiditas.Accounts.User{hashed_password: hashed_password}, password)
